...
If Request("ResetIP") <> "" Then

	strWebcamIP = Request.ServerVariables("REMOTE_ADDR")

	strWebCamURL = "http://" + strWebCamIP + ":8080"

	Application("WebcamURL") = strWebCamURL

	Response.write "<h2>Webcam URL has been reset to " + Application("WebCamURL") +"</h2>"
End If
